  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        // color: mobileBackgroundColor, //TODO: Social card color
      ),
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                widget.snap['uid'].toString() == auth.currentUser!.uid
                    ? IconButton(
                        onPressed: () {
                          showDialog(
          ...
          Row(
            children: <Widget>[
              LikeAnimation(
                ...
                smallLike: true,
                child: IconButton(
                  icon: widget.snap['likes'].contains(auth.currentUser!.uid)
                      ? const Icon(
                          IconlyBold.heart,
                          color: Colors.red,
                        )
              ...
              children: <Widget>[
                DefaultTextStyle(
                    ...
                    child: Text(
                      ...
                      // style: Theme.of(context).textTheme.bodyText2, // intinaranti
